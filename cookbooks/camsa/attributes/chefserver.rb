...
default['camsa']['chefserver']['download']['url'] = "https://packages.chef.io/files/stable/chef-server/%s/ubuntu/18.04/chef-server-core_%s-1_amd64.deb" % [node['camsa']['chefserver']['version'], node['camsa']['chefserver']['version']]
